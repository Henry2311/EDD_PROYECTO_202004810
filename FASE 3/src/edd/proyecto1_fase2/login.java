...
import edd.proyecto1_fase2.Arbol_B.NodoB;
...
public class login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user.equals("admin") && pass.equals("EDD2022")){
            ...
            NodoB cliente = EDDProyecto1_fase2.CLIENTES.Search(Long.parseLong(user));
            if(cliente != null){
                if(cliente.c.dpi == Long.parseLong(user) && cliente.c.password.equals(pass)){
                    new cliente(cliente.c).setVisible(true);
                    this.dispose();
                }
            }else{
